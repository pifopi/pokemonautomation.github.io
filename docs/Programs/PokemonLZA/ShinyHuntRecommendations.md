...
| Charmander<br>Tepig<br>Lucario<br>Hippowdon | Use the East side benches near the fly entrance of Wild Zone 20.<br><br>**Run Forward Direction:** 9000 ms<br><br>This method will run through the alphas to hit the far side. It hits all but one of west side spawners.<br><br>(Credit: quantum____) | [<img src="images/ShinyHuntLocations/BenchSit-WZ20-small.png" width="300">](images/ShinyHuntLocations/BenchSit-WZ20.png) |
